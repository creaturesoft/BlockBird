    ...
    IEnumerator SpawnBlock()
    {
        ...
        while (true)
        {
            ...
            for (int y = -Steps; y <= Steps; y++)
            {
                ...
                if (blockRate < 38)
                {
                    blockList.Add(
                        Instantiate(block1Prefab, new Vector3(0, BlockGap * y, 0), Quaternion.identity)
                            .Init(currentDepth.transform, Random.Range(lifeWeight * 2f, lifeWeight * 3f), 5, true));
                }
                else
                {
                    float type = Random.Range(0f, 100f);
                ...
                //    blockList.Add(
                //        Instantiate(block1Prefab, new Vector3(0, BlockGap * y, 0), Quaternion.identity)
                //            .Init(currentDepth.transform, Random.Range(lifeWeight * 2f, lifeWeight * 3f), 2, true));
                //}
                //else if (blockRate < 50)
                //{
                //    blockList.Add(
                //        Instantiate(block1Prefab, new Vector3(0, BlockGap * y, 0), Quaternion.identity)
                //            .Init(currentDepth.transform, Random.Range(lifeWeight * 3f, lifeWeight * 4f), 5, true));
                //}

            }


            if (totalDepth > 50 + stepBlockCount)
            {
                break;
            }
        }
