...
public class BossWeekFind : MapBase
{
        ...
        while (true)
        {
            ...
            for (int y = -Steps; y <= Steps; y++)
            {
                ...
                else
                {
                    ...
                    {
                        isSetSpeed = true;
                        GameManager.Instance.Character.Speed = GameManager.Instance.Character.IsMeleeAttack ? 2.5f : 2.5f;
                    }
                }
                ...
                if (totalDepth % 7 == 0)
                {
                    if (randomeWeak == y) {
                        ...
                        blockList.Add(
                               ...
                               .Init(currentDepth.transform, Random.Range(lifeWeight / 2, lifeWeight / 1.5f), 5, true));
                    }
                    else
                    {
                        ...
                        blockList.Add(
                                    Instantiate(block1Prefab, new Vector3(0, BlockGap * y, 0), Quaternion.identity)
                               .Init(currentDepth.transform, Random.Range(lifeWeight*2f, lifeWeight*4f), 5, true));
                    }
                }
                else
                {
