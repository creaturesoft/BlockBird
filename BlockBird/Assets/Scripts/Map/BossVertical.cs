...
public class BossVertical : MapBase
{
                ...
                if (totalDepth % 5 == 0)
                {
                    if (y == Steps || y == -Steps)
                    {
                        ...
                        blockList.Add(
                            ...
                            .Init(currentDepth.transform, Random.Range(lifeWeight / 2, lifeWeight * 3f), 5, true));
                    }
                    else
                    {
                        ...
                        blockList.Add(
                                    Instantiate(block1Prefab, new Vector3(0, BlockGap * y, 0), Quaternion.identity)
                            .Init(currentDepth.transform, Random.Range(lifeWeight / 2, lifeWeight * 1f), 5, true));
                    }
                }
                else
                {
